    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_fixed_transactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_fixed_transactions_categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_fixed_transactions_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFixed = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_fixed_transactions_CategoryId",
                table: "fixed_transactions",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_fixed_transactions_UserId",
                table: "fixed_transactions",
                column: "UserId");
